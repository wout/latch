...
describe Latch::Storage::FileSystem do
  temp_dir = File.tempname("latch_spec")
  ...
  describe "#upload and #open" do
    it "writes and reads file content" do
      storage = Latch::Storage::FileSystem.new(temp_dir)
    ...
    it "respects the prefix" do
      storage = Latch::Storage::FileSystem.new(temp_dir, prefix: "cache")
  ...
  describe "#delete" do
    ...
    it "skips cleanup when clean is false" do
      storage = Latch::Storage::FileSystem.new(temp_dir, clean: false)
      storage.upload(IO::Memory.new("data"), "a/b/test.txt")
      storage.delete("a/b/test.txt")
  ...
  describe "#url" do
    ...
    it "includes the prefix in the URL" do
      storage = Latch::Storage::FileSystem.new(temp_dir, prefix: "uploads/cache")
