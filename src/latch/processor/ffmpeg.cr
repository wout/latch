...
@[Latch::VariantOptions(
  ...
  crf: String?,           # constant rate factor, e.g. "23"
  duration: String?,      # max duration, e.g. "10"
  format: String?,        # output format, e.g. "mp4", "webm", "image2"
  frame_rate: String?,    # output frame rate, e.g. "30"
  frames: String?,        # number of frames to output, e.g. "1"
